...
var containerWrap = document.querySelector('.advantages');
var advantages = JSON.parse(data).advantages;
advantages.forEach(function (advantage) {
  var imgUrl = advantage.imgUrl,
...
function renderAdvantageItem(imgUrl, title, subtitle) {
  ...
  blockContent.innerHTML = "\n    <div class=\"blocks__image\">\n        <img src=\"".concat(imgUrl, "\" alt=\"\" class=\"blocks__dark\">\n        <h3 class=\"blocks__text\">").concat(title, "</h3>\n        <h4 class=\"blocks__text4\">").concat(subtitle, "</h4>\n    </div>\n");
  return blockContent;
}
...
//# sourceMappingURL=/test-project.e31bb0bc.js.map